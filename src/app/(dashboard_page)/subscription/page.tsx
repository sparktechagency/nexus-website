  ...
  return (
    <div className='max-w-[50vw] mx-auto pt-8'>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 items-stretch">
        ...
        {/* Basic Plan */}
        <div className="bg-[#DBEAFE] rounded-3xl p-6 text-center flex flex-col h-full ">
        ...
        {/* Standard Plan */}
        <div className="bg-[#D1FAE5] rounded-3xl p-6 text-center flex flex-col h-full ">
          <div className="mb-4 flex justify-center">
        ...
        {/* Premium Plan */}
        <div className="bg-[#FEF3C7] rounded-3xl p-6 text-center flex flex-col h-full  ">
