            ...
            <TableBody>
              {zoonListData?.map((item, index: number) => (
                ...
                >
                  ...
                  <TableCell className="text-foreground">{item.gaming_zone_name}</TableCell>
                  <TableCell className="text-foreground">{item.phone}</TableCell>
                  <TableCell className="text-foreground">{item.opening_time}</TableCell>
                  <TableCell className="text-foreground">{item.closing_time}</TableCell>
                  <TableCell>
                    <svg
                      onClick={() => {
                        setIsOpen(!isOpen);
