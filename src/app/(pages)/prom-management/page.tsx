...
export default function PromoManagement() {
    ...
    const { data: getPromo, isLoading, refetch } = useGetUserListApiQuery({ per_page: perPage, page: currentPage });
    const promoData: PromoCodeProps[] = getPromo?.data?.data
    const totalItems = getPromo?.data?.total
    ...
    return (
        <div className="text-[#fff]  px-4 md:px-6 lg:px-8 mb-6 pt-4">
            ...
            {
                promoData?.length > 0 ? <div className="bg-gradient-to-r from-[#0f0829] via-black to-[#0f0829] rounded-lg p-6 ">
