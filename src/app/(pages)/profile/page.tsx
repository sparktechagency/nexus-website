...
import { useGetProfileApiQuery, useGetRatingProfileApiQuery } from "@/redux/website/profile/profileApi"
...
export default function WebProfilePage() {
  ...
  // rating profile data
  const { data: getRatingProfile } = useGetRatingProfileApiQuery(null)
