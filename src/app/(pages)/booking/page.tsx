              ...
              <table className="min-w-full">
                ...
                <tbody>
                  {timeLabels.map((timeLabel, rowIndex) => (
                    <tr key={rowIndex}>
                      <td className="min-w-[150px] text-[10px] md:text-[14px] xl:text-[16px] px-1 xl:px-4 py-2 text-center border border-gray-800 text-gray-500">
                        {timeLabel}
                      </td>
                      {pcNumber && Array.from({ length: pcNumber.no_of_pc ?? 0 }, (_, colIndex) => {
                        ...
                        return (
                          <td
                            ...
                            className={cn(
                              "px-1 xl:px-4 py-2 md:py-6 border border-gray-800 text-center min-w-[200px] cursor-pointer transition-all duration-200",
                              booking ? "bg-red-500 text-white font-semibold" : ""
                            )}
                          >
                            {booking ? (
                              <div className="flex flex-col items-center justify-center">
                                <span className="text-sm font-bold">{booking.user.name}</span>
