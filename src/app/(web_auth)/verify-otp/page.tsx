...
export default function VerifyOtPPage() {
    ...
    return (
        ...
        //   <Card className="w-full max-w-md rounded-xl border-none bg-[#2A2A2A] p-6 text-center shadow-lg">
        //     <CardHeader className="space-y-4">
        //       <div className="flex justify-center">
        //         <Image
        //           src="/placeholder.svg?height=100&width=100"
        //           alt="Abstract metallic object"
        //           width={100}
        //           height={100}
        //           className="h-24 w-24 object-contain"
        //         />
        //       </div>
        //       <CardTitle className="text-3xl font-bold text-white">Verify Email</CardTitle>
        ...
        //               }}
        //               className={cn(
        //                 "h-14 w-14 text-center text-2xl font-bold text-white",
        //                 "rounded-lg border border-gray-700 bg-[#3A3A3A] focus:border-purple-500 focus:ring-purple-500",
        ...
        //       <Button
        //         variant="ghost"
        //         className="w-full rounded-lg bg-[#3A3A3A] py-3 text-lg font-semibold text-white hover:bg-[#4A4A4A]"
        //       >
        //         Back
        //       </Button>
        //     </CardContent>
