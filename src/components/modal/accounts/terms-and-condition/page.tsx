...
const TermsAndCondition = () => {
    ...
    const termsContentData = getTermsData?.data[0]
            ...
            <div className="text-[#fff] pb-4 xl:p-8">
                ...
                >
                    <div className="flex items-center gap-2 mb-8">
                        ...
                        <span className="xl:text-xl font-medium">Updated {termsContentData?.updated_at ? moment(termsContentData?.updated_at).format('LL') : ''}
                        </span>
                    </div>


                    <div >
                        <h2 className="text-gray-300 leading-relaxed" dangerouslySetInnerHTML={{ __html: termsContentData?.text }} />
                    </div>
