                ...
                <div className="flex items-center space-x-4">
                    <div className="relative cursor-pointer">
                        <svg
                            ...
                            className=" w-[20px] h-[20px] md:w-[45px] md:h-[45px]  rounded-full" width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="absolute -top-1 left-3 md:left-8 text-[6px] md:text-[10px] bg-red-500 p-[2px] md:p-[3px] rounded-full">{notificationCount}</p>
                    </div>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger className="flex items-center space-x-1 md:space-x-2 cursor-pointer focus:outline-none bg-[#292531] p-2 md:p-3 rounded-full">
                            ...
                            {
                                profileData?.name && <span className="text-[8px] md:text-xl md:font-medium">{profileData?.name}</span>
                            }
