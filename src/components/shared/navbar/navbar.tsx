            ...
            <nav className="bg-[#1e1829] flex items-center justify-between bg-card-bg rounded-full p-2 md:p-4 mb-6 shadow-lg">
                ...
                <div className="flex items-center space-x-4">
                    <div className="relative cursor-pointer">
                        ...
                        <p className="absolute top-0  right-0 w-[12px] h-[12px] md:w-[18px] md:h-[18px] flex justify-center items-center bg-red-500  text-[6px] md:text-[10px] rounded-full">{notificationCount}</p>
                    </div>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger className="flex items-center space-x-1 md:space-x-2 cursor-pointer focus:outline-none bg-[#292531] p-2 md:p-3 rounded-full">
...

                                {
                                    profileData?.subscription_type === "Free"
                                        ...
                                        : profileData?.subscription_type === "Basic"
                                            ? (
                                                <svg className="absolute w-[10px] h-[10px] left-2 -top-2 md:left-4 md:-top-3 md:w-[20px] md:h-[20px]" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            : profileData?.subscription_type === "Standard"
                                                ...
                                                : profileData?.subscription_type === "Premium"
                                                    ? (
                                                        <svg className="absolute w-[10px] h-[10px] left-2 -top-2 md:left-4 md:-top-3 md:w-[20px] md:h-[20px]" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {
                                profileData?.name && <span className="text-[8px] md:text-xl md:font-medium hidden lg:block">{profileData?.name}</span>
                            }

                            {profileData?.name && (
                                <span className="text-[8px] md:text-xl md:font-medium lg:hidden">
                                    {profileData.name.length > 15 ? `${profileData.name.slice(0, 15)}...` : profileData.name}
                                </span>
                            )}
